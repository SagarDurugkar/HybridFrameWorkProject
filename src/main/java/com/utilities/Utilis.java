...
public class Utilis {
	...
	public static String generateEmailTimeStamp() {
		Date d1=new Date();
		String timestamp = d1.toString().replace(" ", "_").replace(":","_");
		return "amotoori"+timestamp+"@gmail.com";
	}
	
	public static Object[][] getDataFromExcel(String sheetName) {
		File excelFile=new File(System.getProperty("user.dir")+"\\src\\main\\java\\com\\testdata\\TestData.xlsx");
	...
	public static String captureScreenshot(WebDriver driver,String testName) {
		...
		String destinationSereenshotPath=System.getProperty("user.dir")+"\\Screenshots\\"+testName+".png";
		try {
			FileHandler.copy(srcsrcScreenshot, new File(destinationSereenshotPath));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return destinationSereenshotPath;
	}
